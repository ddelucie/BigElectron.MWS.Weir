            ...
            do
            {
                ...
                try
                {
                    ...
                    using (HttpWebResponse httpResponse = request.GetResponse() as HttpWebResponse)
                    {
						...
						// HACK to get around bug with Report result 
						if (typeof(T) == typeof(GetReportResponse))
						{
							StreamReader reader = new StreamReader(httpResponse.GetResponseStream(), Encoding.UTF8);
							responseBody = reader.ReadToEnd();

							GetReportResponse r = new GetReportResponse();
							r.GetReportResult = new GetReportResult();
							r.GetReportResult.Content = responseBody;
							response = (T)(object)r ;
							//response.RequestReportResult
